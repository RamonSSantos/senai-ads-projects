...
public class Subtracao { //Iniciando a classe Subtracao
	...
	public String calcular(int num1, int num2) { //Declarando o método DINAMICO calcular() tipo String. Passando neste método as variaveis num1, num2, de tipo int
		...
		msg = "A subtracao é: " + dResultado; //Atribui na variavel msg a mensagem de acordo com a operacao e faz a concatenaçao do resultado da operacao
